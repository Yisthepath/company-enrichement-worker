...
def email_extractor(useful_links_list):
    ...
    for link in links_to_visit:
        try:
            ...
            emails_in_html = re.findall(r"[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}", result.text)
            ...
            logging.error(f"fetching {link} resulted in the following error: {e} (status code: {result.status_code})")
...
test_list = [
				{
					...
					"link": "https://shopify.com/blog/what-is-shopify"
				},
				{
					"text": "Careers",
				...
				{
					"text": "Investors",
					"link": "https://shopify.com/investors"
				},
				{
					"text": "Newsroom",
					"link": "https://shopify.com/news"
				},
				{
					"text": "Blog",
					"link": "https://shopify.com/blog"
				},
				{
					"text": "Guides",
					"link": "https://shopify.com/blog/topics/guides"
				},
				{
					"text": "",
					"link": "https://linkedin.com/company/shopify"
				}
			]